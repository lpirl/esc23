...
def autogenerated_backup_file_name():
    pass

def ardour3_created_ardour2_session_backup():
    pass
...
in_a2 = ElementTree(file=args.a2_file),
logging.debug("loading from '%s'" % args.a3_file)
in_a3 = ElementTree(file=args.a3_file),

# backup
logging.debug("backuing up to '%s'" % args.backup_file)
copy(args.a3_file, args.backup_file)

out_a3_tree = esc23.process(in_a2, in_a3)
